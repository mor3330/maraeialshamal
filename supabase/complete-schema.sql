-- ============================================================
-- مراعي الشمال - النظام الكامل والمحسّن
-- ============================================================

-- 1️⃣ حذف الجداول القديمة
...
-- 5️⃣ حقول الخطوات المحسّنة

-- الخطوة 1: الوارد (كمية + وزن + سعر)
INSERT INTO step_fields (step, field_name, field_label, field_type, is_required, sort_order, help_text) VALUES
  ...
  (1, 'hashi_price', 'السعر (ريال)', 'number', true, 3, 'إجمالي سعر الحاشي'),
  (1, 'sheep_count', 'عدد الرؤوس', 'number', true, 4, null),
  (1, 'sheep_weight', 'الوزن (كجم)', 'number', true, 5, null),
  (1, 'sheep_price', 'السعر (ريال)', 'number', true, 6, 'إجمالي سعر الغنم'),
  (1, 'beef_count', 'عدد الرؤوس', 'number', true, 7, null),
  (1, 'beef_weight', 'الوزن (كجم)', 'number', true, 8, null),
  (1, 'beef_price', 'السعر (ريال)', 'number', true, 9, 'إجمالي سعر العجل');
...
-- الخطوة 4: الصادر (مفصّل)
INSERT INTO step_fields (step, field_name, field_label, field_type, is_required, sort_order, help_text) VALUES
  (4, 'hashi_outgoing', 'الوزن (كجم)', 'number', false, 1, 'الصادر من الحاشي'),
  (4, 'sheep_outgoing', 'الوزن (كجم)', 'number', false, 2, 'الصادر من الغنم'),
  (4, 'beef_outgoing', 'الوزن (كجم)', 'number', false, 3, 'الصادر من العجل'),
  (4, 'offal_to_slaughterhouse', 'المخلفات المسلمة للمسلخ', 'textarea', false, 4, 'بيان المخلفات المسلمة');
...
INSERT INTO step_fields (step, field_name, field_label, field_type, is_required, sort_order, help_text) VALUES
  ...
  (5, 'offal_remaining', 'مخلفات متبقية', 'textarea', false, 4, 'اذكر التفاصيل');
...
INSERT INTO step_fields (step, field_name, field_label, field_type, is_required, sort_order, help_text) VALUES
  (7, 'expenses', 'المصروفات', 'text', false, 1, 'سيتم إضافة جدول المصروفات'),
