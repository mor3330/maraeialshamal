...
export async function POST(req: NextRequest) {
  ...
  const prompt = `أنت نظام ذكاء اصطناعي متخصص في قراءة تقارير مبيعات المحلات في المملكة العربية السعودية.
الصورة تحتوي على تقرير "مبيعات حسب المنتج" (Sales by Product) من نظام نقاط البيع (POS).

**مهمتك:**
اقرأ الجدول بدقة واستخرج كل صف منتج مع:
1. رمز المنتج (Code/رمز) - إذا موجود
2. اسم المنتج (Product name)
3. الكمية المباعة (الكمية / Quantity) - رقم عشري
4. الإجمالي (Total / الإجمالي) - المبلغ الكلي لهذا المنتج بالريال

**تصنيف المنتجات:**
صنّف كل منتج في إحدى الفئات التالية بناءً على اسمه:
- "hashi": أي منتج يحتوي اسمه على "حاشي" أو "هجين" أو "ناقة"
- "sheep": أي منتج يحتوي اسمه على "غنم" أو "خروف" أو "نعجة" أو "حمل" أو "خراف" أو "ضأن" أو "عنز" أو "جدي" أو "تيس"
- "beef": أي منتج يحتوي اسمه على "عجل" أو "بقر" أو "ثور" أو "إبل" أو "جمل"
- "offal": أي منتج يحتوي اسمه على "كبدة" أو "كراعين" أو "رأس" أو "مخلفات" أو "رقبة" أو "كوارع" أو "نخاع" أو "طحال" أو "قلب" أو "كرش" أو "مصران" أو "ركس" أو "ذنب"
- "other": أي شيء آخر (مثل التقطيع، العمل اللحام، إلخ)

**قواعد مهمة:**
- اقرأ الجدول من أعلى لأسفل
- لا تتجاهل أي صف حتى لو الصورة غير واضحة تماماً
- الأرقام بالريال السعودي
- الكمية قد تكون بالكيلو أو العدد (خذها كما هي)
- أجب بـ JSON خام فقط بدون markdown

**تنسيق الإجابة المطلوب:**
{
  "products": [
    {"code": "00012", "name": "اسم المنتج", "quantity": 5.155, "total": 377.00, "category": "hashi"},
    {"code": "00019", "name": "اسم المنتج", "quantity": 4, "total": 174.40, "category": "sheep"}
  ]
}

اقرأ الجدول الآن وأعطني كل الصفوف:`;
